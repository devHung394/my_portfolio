      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                {[
                  ...
                  <Badge
                    key={t}
                    className="rounded-full bg-white/8 text-white hover:bg-white/8"
                    variant="secondary"
                  >
                    {t}
                  </Badge>
              ...
              <div className="space-y-4 text-base leading-relaxed text-white/75">
                ...
                >
                  Software Engineering student at HCMUTE (2022–), building
                  projects across web & mobile with a focus on usability and
                  dev-friendly handoff. Currently seeking a UI/UX internship to
                  grow inside a real product team.
                </p>
              </div>
            </div>
            ...
            >
              {STATS.map((s, i) => (
                ...
                >
                  ...
                  <span className="mt-0.5 text-[10px] text-white/40 leading-tight">
                    {s.label}
                  </span>
                </div>
              ))}
            ...
            <div className="space-y-3">
              <h3
                className={fx("text-sm font-semibold text-white/75")}
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  {
                    Icon: Layout,
                    text: "UX Flows • IA • Wireframes",
                    delay: 420,
                  },
                  {
                    Icon: Sparkles,
                    text: "UI Design • Design System",
                    delay: 460,
                  },
                  {
                    Icon: Code2,
                    text: "Frontend UI Implementation",
                    delay: 500,
                  },
                  {
                    Icon: GraduationCap,
        ...
        >
          <p className="mb-4 text-center text-xs tracking-[0.35em] text-white/30">
            TOOLS & TECHNOLOGIES
          </p>
          <div className="relative">
            ...
            <div className="flex animate-marquee-left whitespace-nowrap will-change-transform">
              ...
              {[...TOOLS, ...TOOLS].map((t, i) => (
                <span
                  key={i}
                  className="inline-flex items-center gap-2 mx-4 text-sm text-white/40 hover:text-white/70 transition-colors cursor-default"
                >
